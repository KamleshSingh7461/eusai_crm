# EUSAI Hub Tactical Deployment Guide
...
## 6. macOS Command (MacBook / Mac Studio)
**Run these steps to update the macOS desktop application.**
...
1. **Flutter Build**:
   ...
   ```
   *   **Target File**: `eusai_messenger_app/build/macos/Build/Products/Release/eusai_hub.app`
   *   **Action**: Compress this as a `.zip` or create a `.dmg` and move to `public/downloads/EUSAI_Hub_MacOS.dmg`.
...
| **App Logic** | macOS | Local | `flutter build macos` |
