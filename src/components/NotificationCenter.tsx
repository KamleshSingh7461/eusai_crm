...
export default function NotificationCenter() {
    ...
    return (
        <div className="relative" ref={popupRef}>
            ...
            {isOpen && (
                <div className="absolute right-0 top-full mt-2 w-80 sm:w-96 bg-white rounded-lg shadow-xl border border-[#DFE1E6] z-50 animate-in fade-in slide-in-from-top-2 duration-200 overflow-hidden flex flex-col max-h-[80vh]">
