...
export default function TeamPage() {
    ...
    const getRoleColor = (role: string) => {
        switch (role) {
            ...
            case 'EMPLOYEE': return 'bg-[#DFE1E6] text-[#172B4D]'; // Gray
    ...
    return (
        <div className="space-y-6 md:space-y-8 p-4 md:p-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-[#172B4D] mb-1 md:mb-2 font-display">Team Management</h1>
                    <p className="text-[#6B778C] text-sm md:text-base">
            ...
            {['DIRECTOR', 'MANAGER', 'TEAM_LEADER'].includes(userRole) && (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 animate-in slide-in-from-top-4 duration-500">
                    <div className="card-jira p-5 bg-white border border-[#DFE1E6] rounded-sm shadow-sm">
                        <div className="flex items-center gap-4">
                            <div className="w-10 h-10 rounded-lg bg-[#EAE6FF] flex items-center justify-center text-[#403294]">
                                <Users className="w-5 h-5" />
                            </div>
                            <div>
                                <h3 className="text-[10px] font-bold text-[#6B778C] uppercase tracking-wider">Team Size</h3>
                                <div className="text-xl font-bold text-[#172B4D]">{users.length} Members</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card-jira p-5 bg-white border border-[#DFE1E6] rounded-sm shadow-sm">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-[10px] font-bold text-[#6B778C] uppercase tracking-wider">Dept Count</h3>
                                <div className="text-xl font-bold text-[#172B4D]">
                    ...
                    <div className="card-jira p-5 bg-white border border-[#DFE1E6] rounded-sm shadow-sm">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-[10px] font-bold text-[#6B778C] uppercase tracking-wider">Active Tasks</h3>
                                <div className="text-xl font-bold text-[#172B4D]">
                                    {meta?.totalTasks || 0}
                                </div>
                            </div>
                    ...
                    <div className="card-jira p-5 bg-white border border-[#DFE1E6] rounded-sm shadow-sm">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-[10px] font-bold text-[#6B778C] uppercase tracking-wider">Avg Efficiency</h3>
                                <div className="text-xl font-bold text-[#172B4D]">
            ...
            {/* Content */}
            <div className="card-jira p-0 bg-white border border-[#DFE1E6] rounded-sm shadow-sm overflow-hidden">
                {/* Toolbar */}
                <div className="p-4 border-b border-[#DFE1E6] flex flex-col lg:flex-row lg:items-center justify-between bg-[#FAFBFC] gap-4">
                    <div className="relative w-full lg:max-w-sm">
                        ...
                        <input
                            ...
                            className="w-full bg-white border border-[#DFE1E6] rounded-sm py-2 pl-10 pr-4 text-sm text-[#172B4D] focus:outline-none focus:ring-2 focus:ring-[#0052CC] transition-all"
                        />
                    </div>
                    <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
                        <div className="flex items-center gap-2 w-full sm:w-auto">
                            <Shield className="w-4 h-4 text-[#6B778C] shrink-0" />
                            <select
                                value={filterRole}
                                onChange={(e) => setFilterRole(e.target.value)}
                                className="w-full sm:w-auto bg-white border border-[#DFE1E6] rounded-sm px-2 py-1.5 text-xs font-bold text-[#42526E] focus:outline-none"
                            >
                        ...
                        <div className="flex items-center gap-2 w-full sm:w-auto">
                            <Briefcase className="w-4 h-4 text-[#6B778C] shrink-0" />
                            <select
                                value={filterDept}
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left min-w-[1000px]">
                            <thead className="bg-[#FAFBFC] border-b border-[#DFE1E6]">
                                <tr>
                                    <th className="px-6 py-4 text-[10px] font-extrabold text-[#6B778C] uppercase tracking-widest">Rank</th>
                                    <th className="px-6 py-4 text-[10px] font-extrabold text-[#6B778C] uppercase tracking-widest">Team Member</th>
                                    <th className="px-6 py-4 text-[10px] font-extrabold text-[#6B778C] uppercase tracking-widest">Role</th>
                                    <th className="px-6 py-4 text-[10px] font-extrabold text-[#6B778C] uppercase tracking-widest text-center">Efficiency</th>
                                    <th className="px-6 py-4 text-[10px] font-extrabold text-[#6B778C] uppercase tracking-widest text-center">Activity</th>
                                    <th className="px-6 py-4 text-[10px] font-extrabold text-[#6B778C] uppercase tracking-widest">Managed By</th>
                                    {['DIRECTOR', 'MANAGER'].includes(userRole) && (
                                    ...
                                    <tr key={user.id} className="hover:bg-[#FAFBFC] transition-colors group">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2">
                                                <span className={`text-sm font-bold ${[1, 2, 3].includes(user.rank || 0) ? 'text-[#0052CC]' : 'text-[#6B778C]'}`}>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="min-w-0">
                                                    <div className="font-bold text-[#172B4D] text-sm flex items-center gap-2">
                                                        {user.name || 'No Name'}
                                                        {user.rank && user.rank <= 3 && <Award className={`w-3.5 h-3.5 ${user.rank === 1 ? 'text-[#FFAB00]' : 'text-[#6B778C]'}`} />}
                                                    </div>
                                                    <div className="text-[10px] text-[#6B778C] truncate">{user.email}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                            <div className="flex flex-col gap-1">
                                                ...
                                                <span className="text-[9px] font-bold text-[#6B778C] uppercase">{user.department || 'General'}</span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                            <div className="flex items-center justify-center gap-3">
                                                <div className="flex flex-col items-center">
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        {user.performanceTrend === 'NEUTRAL' && <Minus className="w-3 h-3 text-[#6B778C]" />}
                                                    </div>
                                                    <div className="w-16 h-1 bg-[#EBECF0] rounded-full mt-1 overflow-hidden">
                                                        <div
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <div className="flex flex-col items-center gap-1">
                                                <div className="flex items-center gap-2">
                                                    <span className="text-sm font-bold text-[#172B4D]">{user.activeTasks || 0}</span>
                                                ...
                                                <span className="text-[9px] text-[#6B778C]">{user._count?.milestones || 0} Milestones</span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                            {user.manager ? (
                                                <div className="flex items-center gap-2 text-[#42526E] text-xs">
                                                    <div className="w-5 h-5 rounded-full bg-[#FAFBFC] border border-[#DFE1E6] flex items-center justify-center text-[8px] font-bold">
                                                        {user.manager.name?.charAt(0) || 'M'}
                                                    </div>
                                                    <span className="truncate max-w-[80px]">{user.manager.name}</span>
                                                </div>
                                            ) : (
                                                <span className="text-[#6B778C] italic text-[10px]">Independent</span>
                                            )}
                                        </td>
                                        {['DIRECTOR', 'MANAGER'].includes(userRole) && (
                                            <td className="px-6 py-4 text-right">
                                                <button
                                                    ...
                                                    className="p-1.5 hover:bg-[#EBECF0] rounded-sm text-[#42526E] transition-colors"
                                                >
            ...
            {(isInviteModalOpen || isEditModalOpen) && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-300">
                    <div className="card-eusai w-full max-w-lg bg-white rounded-sm shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
                        ...
                        <form onSubmit={isEditModalOpen ? handleUpdate : handleInvite} className="p-6 space-y-4">
                            {!isEditModalOpen && (
                                <div className="space-y-1.5">
                                    <label className="text-xs font-bold text-[#6B778C] uppercase">Email Address</label>
                                    <div className="relative">
                                        <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#6B778C]" />
                                        <input
                                            type="email"
                                            required
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-[#6B778C] uppercase">Full Name</label>
                                <input
                                    value={formData.name}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <label className="text-xs font-bold text-[#6B778C] uppercase">System Role</label>
                                    <div className="relative">
                                        <Shield className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#6B778C]" />
                                        <select
                                            value={formData.role}
                                            onChange={e => setFormData({ ...formData, role: e.target.value })}
                                            className="w-full pl-9 pr-3 py-2 bg-[#FAFBFC] border border-[#DFE1E6] rounded-sm text-sm focus:border-[#0052CC] outline-none cursor-pointer"
                                        >
                                            <option value="EMPLOYEE">Employee</option>
                                            <option value="INTERN">Intern</option>
                                            <option value="TEAM_LEADER">Team Leader</option>
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-xs font-bold text-[#6B778C] uppercase">Department</label>
                                    <input
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-[#6B778C] uppercase">Reports To (Manager)</label>
                                <div className="relative">
                                    <GitMerge className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#6B778C]" />
                                    <select
